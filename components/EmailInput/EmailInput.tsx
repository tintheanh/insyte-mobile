...
function EmailInput({ value, setEmail }: EmailInputProps) {
	...
	return (
		<View style={styles.textBoxWrapper}>
			<SimpleLineIcons name='envelope' size={24} color={Colors.normalText} style={styles.icon} />
			<TextInput
...
export default memo(EmailInput, (prevProps: EmailInputProps, nextProps: EmailInputProps) => {
